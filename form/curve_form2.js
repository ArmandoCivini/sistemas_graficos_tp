...
export class CurveForm2 extends Form {
    constructor(steps, controlPointsFull) {
        let vertices = [];
        let delta = 1/steps;
        var vec3=glMatrix.vec3;

        for (let u=0; u < controlPointsFull.length; u+=4) {
            let controlPoints = controlPointsFull.slice(u, u+4);
        ...
        super(vertices, (steps+1) * (controlPointsFull.length) / 4);
    }
}